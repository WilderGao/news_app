...
public class ManagerService {
    ...
    public List<Manager> showManager() {
        ...
        List<Manager> st =  dao.showManager();
        return st;
    }
    /**
     * 展示所有状态为未审批的账号
    ...
    public List<Manager> showUnApprovalManager(){
        ...
        List<Manager> unapprovalManager = dao.showUnapprovalManager();
    ...
    public List<News> showManagerOwnNews(int managerId){
        ...
        List<News> ownNews = dao.showOwnNews(managerId);
        return ownNews;
    }
    ...
    private void sendActivationMail(String email, String code) {
        ...
        String setContent = "<h1>此邮件为激活邮件！请点击下面链接完成激活操作！</h1><h3><a href='http://" +
                "192.168.43.141:8080/admin/verifyaccount?code="
                + code
                + "'>http://192.168.43.141:8080/admin/verifyaccount</a></h3>";
